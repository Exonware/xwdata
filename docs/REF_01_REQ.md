...
| Primary users/beneficiaries | Developers. xwschema, xwaction, xwentity, xwstorage.connect and others will use it. Heavily extends XW object (xwsystem) by linking xwnode capabilities and serialization. |
